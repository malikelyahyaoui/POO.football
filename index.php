...
// Ajout des carrières aux joueurs respectifs
$neymar->ajouterCarriere($carriereNeymar);
$mbappe->ajouterCarriere($carriereMbappe);
$messi->ajouterCarriere($carriereMessi);
$cristiano->ajouterCarriere($carriereCristianoRM);
$cristiano->ajouterCarriere($carriereCristianoPorto);
$benzema->ajouterCarriere($carriereBenzema);

// Ajout des carrières aux équipes
    ...
    <?php foreach ([$messi, $cristiano, $neymar] as $joueur) : ?>
        <div class="carriere">
            ...
            <div class="career-details">
                <?php 
                    foreach ($joueur->getCarriere() as $carriere) {
                        echo $carriere->afficherCarriere() . '<br>';
                    }
                ?>
            </div>
        </div>
